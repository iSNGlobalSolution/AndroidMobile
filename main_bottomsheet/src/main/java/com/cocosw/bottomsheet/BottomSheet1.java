 ...
 */
@SuppressLint("NewApi")
public class BottomSheet1 extends Dialog implements DialogInterface {
    ...
    public BottomSheet1(Context context) {
        super(context,R.style.BottomSheet_Dialog);
    }

    @SuppressWarnings("WeakerAccess")
    public BottomSheet1(Context context, int theme) {
        super(context, theme);
    ...
    private void init(final Context context) {
        ...
        final ClosableSlidingLayout mDialogView = (ClosableSlidingLayout) View.inflate(context, R.layout.bottom_sheet1, null);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (builder.listener != null) {
                    builder.listener.onClick(BottomSheet1.this, ((MenuItem) adapter.getItem(position)).id);
                }
                dismiss();
            }
        });
    ...
    public static class Builder {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public BottomSheet1 show() {
        	BottomSheet1 dialog = build();
            dialog.show();
            return dialog;
        }
        ...
        @Deprecated
        public BottomSheet1 create() {
            return build();
        }

        @SuppressLint("Override")
        public BottomSheet1 build() {
        	BottomSheet1 dialog = new BottomSheet1(context, theme);
            dialog.builder = this;
            return dialog;
        }
