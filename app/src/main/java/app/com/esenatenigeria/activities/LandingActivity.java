...
public class LandingActivity extends BaseActivity implements Interfaces.FragmentClick {
    ...
    @BindView(R.id.txt_Contact_Your_Senator)
    TextView txt_Contact_Your_Senator;
    ...
    protected void initListener() {
        ...
        txt_Contact_Your_Senator.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.txt_nav_officers:
                ...
                closeDrawer();
                break;
            case R.id.txt_Contact_Your_Senator:
                loadFragment(SenatorDetailsFragment.newInstance(this, txtTitle), Consts.FRAG_SENATOR_DETAILS);
                closeDrawer();
                break;
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == MarshMallowPermission.EXTERNAL_STORAGE_PERMISSION_REQUEST_CODE && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            for(Fragment fragment : getSupportFragmentManager().getFragments())
            {
                if(fragment!=null)
                {
                    if(fragment.getClass().equals(ActsFragment.class))
                    {
